...
/**
 * Origin of the embedder framing this page, or null when the page runs
 * top-level. Client-only; null during SSR.
 */
 ...
 * Noops (returns a no-op dispose) when not embedded.
 */
